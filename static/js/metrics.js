...
// Note: COLOR_PRESETS is now defined in builtinColormaps.js which loads before this file
// Functions in this file can directly access the global COLOR_PRESETS variable

function testColormaps() {
    // Use colormap IDs from builtinColormaps.js
    var ALL_COLORMAPS = (typeof getAllColormapIds === 'function') ? getAllColormapIds() : [
        'blues', 'purples', 'reds', 'redpurple', 'viridis', 'plasma',
        'coolwarm', 'greyred', 'spectral', 'rainbowjet', 'turbo', 'rainbowcie'
    ];
